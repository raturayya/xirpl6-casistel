        ...
        <div class="row mt-3">
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/mie ayam.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Mie Ayam</h5>
               <label class="card-text harga">Rp. 10.000</label><br>
                <a href="pesanan.php" class="btn btn-primary btn-sm">TAMBAH</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/baksoo.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/soto.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/aymgeprek.jpg" class="card-img-top" alt="...">
              <div class="card-body">
         ...
         <div class="row mt-3">
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/es teh.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/aqua.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/es kopi.png" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Es Kopi</h5>
                <label class="card-text">Rp. 4.000</label><br>
                <a href="pesanan.php" class="btn btn-primary btn-sm">TAMBAH</a>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/es jeruk.jpg" class="card-img-top" alt="...">
              <div class="card-body">
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          ...
          <a href="https://instagram.com/stematelpwt?utm_medium=copy_link"><img src="images/icon/ig.png" class="mr-3" data-toggle="tooltip" title="Instagram"></a>
