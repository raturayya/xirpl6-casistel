      ...
      <nav class="navbar navbar-expand-lg  bg-danger">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="pesanan_ika.php">PESANAN</a>
            </li>
            <li class="nav-item">
            ...
            <div class="card border-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga">Rp. 10.000</label><br>
                <a href="pesanan_ika.php" class="btn btn-primary btn-sm">TAMBAH</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card border-dark">
              ...
              <div class="card-body">
                ...
                <label class="card-text">Rp. 2.000</label><br>
                <a href="pesanan_ika.php" class="btn btn-primary btn-sm">TAMBAH</a>
              </div>
            </div>
          </div>
