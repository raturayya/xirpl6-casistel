...
<body>
    ...
    <form action="pesanan.php" method="post">
        ...
        <input type="date" id="nama" name="tgl_pemesanan" class="form-control" required>
        ...
        <select name= "jenis_makanan" id="nama" class= "form-select">
        ...
        <select name= "jenis_minuman" id="nama" class= "form-select">
        ...
        <option>Pilih Minuman</option>
            ...
            <option value= "Es Jeruk">Es Jeruk</option> </select>
